...
**Carryover from the end of Ep 3 (promises made on camera):** all three in person in Oakland
(pays off the "someone's always on the laptop" gag) · **agentic payments "for real this time"**
(the burrito-via-Perp-of-Fortune bit) · **Jackson's contrarian take finally comes due** (Tyler
took Ep 1 & Ep 3).
...
| B | **MEV & the jaredfromsubway.eth "sandwich" saga** | **Chris** (+ Jackson's contrarian take) | Ethereum's most notorious sandwich bot (~70% of all sandwich attacks) got **drained of $7.5M on June 20–21** in a *reverse honeypot* — the predator got sandwiched. Chris explains MEV; **Jackson's owed contrarian take lands here.** *(Dictation: read "Meb"=MEV, "Jared sandwich"=jaredfromsubway.eth — correct me if not.)* |
...
Optional prep; skim what's relevant to the segment you're leading.
...
**C · "Open USD" / OUSD + the name collision**
